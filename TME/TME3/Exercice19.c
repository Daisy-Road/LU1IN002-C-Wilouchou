...
int main() {
    ...
    /* vous devrez bien sur modifier les parametres d'appel de la fonction stats
     * une fois cette derniere completee */
    stats(VAL1, VAL2, VAL3, VAL4, &min, &max, &moy);

    /* vous devrez bien sur modifier les parametres d'appel de la fonction
     * afficher_resultat */
